...
#static version
Under15_2018_PC_map <- tm_shape(TA) +
  tm_polygons(col="Under15_2018_PC", 
              title="Under 15 years old",
              border.col = "grey20",
              style="quantile", lwd=0.0001, 
              midpoint = NA, palette="Blues") +  
  tm_layout(main.title = "Under 15, %, 2018, Territorial Authorities", 
...
Age15to29_2018_PC_map <- tm_shape(TA) +
  tm_polygons(col="Age15to29_2018_PC", 
              title="Age 15 to 29 years old",
              border.col = "grey20",
              style="quantile", lwd=0.0001, 
              midpoint = NA, palette="Blues") +  
  tm_layout(main.title = "Age 15 to 29, %, 2018, Territorial Authorities", 
            main.title.size = 1, legend.hist.width = 1) +
  tm_compass(position = "right", color.light = "grey90") + 
  tm_scale_bar(position=c("right")) +
  tm_credits(text ="Source: Statistics New Zealand \n Created by A.Prof Malcolm Campbell") 
Age15to29_2018_PC_map

Age30to64_2018_PC_map  <- tm_shape(TA) +
  tm_polygons(col="Age30to64_PC", 
              title="Age 30 to 64 years old",
              border.col = "grey20",
              style="quantile", lwd=0.0001, 
              midpoint = NA, palette="Blues") +  
  tm_layout(main.title = "Age 30 to 64, %, 2018, Territorial Authorities", 
            main.title.size = 1, legend.hist.width = 1) +
  tm_compass(position = "right", color.light = "grey90") + 
  tm_scale_bar(position=c("right")) +
  tm_credits(text ="Source: Statistics New Zealand \n Created by A.Prof Malcolm Campbell") 
Age30to64_2018_PC_map 
...
tmap_arrange(Under15_2018_PC_map,
  Age15to29_2018_PC_map,
  Age30to64_2018_PC_map,
  Over65_2018_PC_map)
